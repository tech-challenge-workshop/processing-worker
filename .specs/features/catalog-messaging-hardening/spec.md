...
| --- | --- | --- | --- |
| MSG-12 | P1: Health suite isolated from the shell (V19.1) | Validate | Verified |
| MSG-13 | P2: Duration-over-format precedence pinned (V19.2) | Validate | Verified |
| MSG-14 | P3: Shutdown never acks in-flight work (V19.3) | Validate | Implementing (open: V49, hook order not pinned; window after the flag check) |
| MSG-15 | P4: Prefetch and non-JSON DLQ against RabbitMQ (V19.4) | Validate | Implementing (open: V49, CI guard unpinned; SyntaxError branch dead for non-JSON) |
